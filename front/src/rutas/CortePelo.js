...
const CortePelo = () => {
  ...
  return (
    <div>
      ...
      <Offcanvas isOpen={isOffcanvasOpen} onClose={closeOffcanvasAndNavigateHome} title="Servicio de Corte de Pelo">
        <form className="corte-pelo-form" onSubmit={handleFormSubmit}>
